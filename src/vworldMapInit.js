...
var vworldErrMsg = '';
var vworldApiKey = '987DB43F-A2A1-3C3B-818F-68E7B9D7E786';
...
vw.ol3.ExtUrls = {
    ...
    openlayers: vw.ol3.BaseURLs.vworldUrl + "/js/map/OpenLayers-" + vworldVers.OpenLayers + "/ol.js",
...
vw.ol3.MapUrls = {
    earth: vworldUrl + vworld3DUrl + "?version=2.0&apiKey=" + vworldApiKey,
    ...
    apiCheck: vw.ol3.BaseURLs.vworldUrl + "/check2DNum.do?version=2.0&key=" + vworldApiKey
};
vw.ol3.CommonFunc = {
    _trim: function(a) {
...
(function() {
    document.write("<script type='text/javascript' src='" + vw.ol3.ExtUrls.jquery + "'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.ExtUrls.jqueryui + "'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.ExtUrls.openlayers + "'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.BaseURLs.vworldUrl + "/js/map/chart/ol3/v2.raphael.js'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.BaseURLs.vworldUrl +
        "/js/map/chart/ol3/v2.g.raphael.max.js'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.BaseURLs.vworldUrl + "/js/map/chart/ol3/v2.g.bar.max.js'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.BaseURLs.vworldUrl + "/js/map/chart/ol3/v2.g.pie.max.js'>\x3c/script>");
    document.write("<script type='text/javascript' src='" + vw.ol3.BaseURLs.vworldUrl + "/js/vw.ol3.2DMapClassInit_v30.js'>\x3c/script>");
    document.write("<script type='text/javascript' src='" +
        vw.ol3.MapUrls.earth + "'>\x3c/script>");
    vw.ol3.CommonFunc._linkExtStyle(vw.ol3.ExtUrls.vmapcss);
    vw.ol3.CommonFunc._linkExtStyle(vw.ol3.ExtUrls.vmap23css);
    document.write("<script type='text/javascript' src='" + vw.ol3.MapUrls.apiCheck + "'>\x3c/script>")
})();